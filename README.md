...
**Assessment: partially reproduced in this bounded CIFAR-10 setup.** At 80,000 updates, the selected grid-8 midpoint model reduced 1-NFE KID × 1,000 to **275.67**, versus **409.06** for naive Euler and **469.12** for matched Euler-target PDD; paired trajectory MSE was **0.0928**, versus **0.6265** for the naive control. The paper's non-comparable ImageNet number likewise favors midpoint—FID **2.69** versus **2.73**. The same checkpoint improved to KID **110.03** at 8 NFE without retraining.
...
| [Grid-8 midpoint](https://github.com/alphaXiv/parallel-decoding-distillation-for-fast-image-an/tree/orx/midpoint-pdd-grid-8-80000) | Halve the number of parallel interval heads | `bash run.sh` | Best 80k model: KID 275.67 → 110.03 | Kubernetes, 1× RTX PRO 6000 Blackwell |
